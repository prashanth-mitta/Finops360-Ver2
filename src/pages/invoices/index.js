...
export default function InvoicesModule(props) {
  ...
  // helper module (calc/format/constants) still lives in invoiceData
  var [data, setData] = React.useState(null);
  React.useEffect(function() {
    setData(require("./invoiceData"));
  }, []);
  React.useEffect(function() {
    setInvoices(liveInvoices ? liveInvoices.slice() : null);
  }, [liveInvoices]);
